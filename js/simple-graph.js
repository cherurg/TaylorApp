...
taylor.core.registerModule(function (app) {
    app.SimpleGraph = function (elemid, options) {
        var self = this;
...
//
    ...
    app.SimpleGraph.prototype.plot_drag = function () {
        var self = this;
        return function () {
...
/*        var circle = this.vis.select("svg").selectAll("circle")
    ...
    app.SimpleGraph.prototype.mousemove = function () {
        var self = this;
        return function () {
    ...
    app.SimpleGraph.prototype.mouseup = function () {
        var self = this;
        return function () {
            document.onselectstart = function () {
                return true;
...
/*            self.graph
    ...
    app.SimpleGraph.prototype.yaxis_drag = function (d) {
        var self = this;
        return function (d) {
            document.onselectstart = function () {
                return false;
